...
![alt text](20260701compare_1.png)  
...
根据上述1和2，10个epoch后，效果比较差，与直觉一致——区分2个标签更复杂  
...
20260702  
运行完毕，性能指标如下：  
![alt text](20260702IoU_200epoch.png)  

![alt text](20260702compare_1.png)  
![alt text](20260702compare_2.png)  
![alt text](20260702compare_3.png)  

总结：  
1. 仍然表现出了检出漏标对象的能力  
2. 两种标签存在混淆的情况，但叠加后覆盖率基本准确  
3. 回到秀珍菇场景，2的问题将不存在  
